...
export class ExteriorsComponent implements OnInit {
  linkList: any[];
  activeLink: any;
  exteriormetaInfo = exterior;
  constructor(
    ...
    this.activeLink = this.linkList[4];
  }
  ...
  updatemetaInfo() {
    this.meta.updateTag({ name: 'description', content: this.exteriormetaInfo.description });
    this.meta.updateTag({ name: 'title', content: this.exteriormetaInfo.title });
    this.api.setpAgetitle(this.exteriormetaInfo.title);
  }
